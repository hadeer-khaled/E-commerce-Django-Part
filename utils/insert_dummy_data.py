...
def insert_dummy_data():
    ...
    product_6, _ = Product.objects.update_or_create(
        ...
        defaults={
            ...
            "image":"https://cdn.dummyjson.com/product-images/6/1.jpg"
        }
    )
...
##############################################################################################################
    ...
    product_17, _ = Product.objects.update_or_create(
        ...
        defaults={
            ...
            "image":"https://cdn.dummyjson.com/product-images/16/1.jpg"
        }
    )
...
##############################################################################################################
    ...
    product_22, _ = Product.objects.update_or_create(
        ...
        defaults={
            ...
            "image":"https://cdn.dummyjson.com/product-images/21/1.jpg"
        }
    )
...
##############################################################################################################
    ...
    product_26, _ = Product.objects.update_or_create(
        ...
        defaults={
            ...
            "image":"https://cdn.dummyjson.com/product-images/25/1.jpg"
        }
    )
...
##############################################################################################################
    ...
    product_33, _ = Product.objects.update_or_create(
        ...
        defaults={
            ...
            "image":"https://cdn.dummyjson.com/product-images/32/1.jpg"
        }
    )
